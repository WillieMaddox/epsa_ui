(function() {
  ...
  OSMFire_Core.saveValueToLocalStorage(OSMFire_GlobalData.getButtonWidgetDefID('AddWmsDefID'),
    AddWmsWidgetDefinition)
  OSMFire_Core.saveValueToLocalStorage(OSMFire_GlobalData.getButtonWidgetDefID('AddWfsDefID'),
